...
#include "nesl_rtw.h"
#include "Nicholas_DCDC_Buck_d41060f2_1.h"
#include "Nicholas_DCDC_Buck_d41060f2_1_gateway.h"

void Nicholas_DCDC_Buck_d41060f2_1_gateway(void)
{
  NeModelParameters modelparams = { (NeSolverType) 0, 0.001, 1, 0, 0.001, 0, 0,
    0, 0, (SscLoggingSetting) 0, 557875547, 0, };
  ...
  Nicholas_DCDC_Buck_d41060f2_1_dae(&dae,
    &modelparams,
    &solverparams);
  nesl_register_simulator_group("Nicholas_DCDC_Buck/Solver Configuration_1",
    1,
    &dae,
    &solverparams,
    &modelparams,
